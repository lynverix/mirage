...
self.addEventListener("activate", (event) => {
  console.log("sw.js: Activating Service Worker and claiming clients...");
...
async function handleRequest(event) {
  try {
    ...
    console.error("Service Worker handleRequest error:", err);
...
self.addEventListener("fetch", (event) => {
  ...
  console.log("sw.js: fetch intercepted for:", url);
